...
[CreateAssetMenu(menuName = "PluggableAI/Decisions/TargetInShortRange")]
public class TargetInShortRangeDecision : Decision {
    public override bool Decide(StateController controller) {
        return (TargetInRange(controller, 12) && TargetIsVisible(controller));
    }
